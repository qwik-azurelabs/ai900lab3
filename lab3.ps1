...
$txt_file = "sample1.txt"
if ($args.count -gt 0 -And $args[0] -in ("sample1.txt", "sample2.txt", "sample3.txt", "sample4.txt"))
{
    $txt_file = $args[0]
}
$url = "https://raw.githubusercontent.com/qwik-azurelabs/ai900lab3/main/data/$txt_file"
